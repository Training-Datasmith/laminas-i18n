...
final class Default_Country_Code_List implements Country_Code_List_Interface
{
    ...
    {
        return array_map(Country_Code::from_string(...), self::LIST);
    }
}